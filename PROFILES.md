...
- Deployed set (v3, 2026-09-11): builder, critic, designer, researcher, planner, merger. v2 hard rules carry into v3; designer added for ai-design-workflow Phase 1-3 units. v2 = hard checkpoint/resume rules (checkpoint after every step, <2min foreground commands + background for long jobs, 60% early-stop, resume-by-default).
